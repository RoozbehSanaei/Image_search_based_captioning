...
# We will use the encoding of an image and use a start word to predict the next word. After that, we will again use the same image and use the predicted word
# to predict the next word. So, the image will be used at every iteration for the entire caption.
